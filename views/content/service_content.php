<div id="content">
	<h2>Stage Left Redesign Services</h2>
	 	<p>
	 		We offer a wide array of various design, staging, interior decorating and other home services.  The following services are fully customizable to meet the needs of each and every client.  So whether you need our professional expertise on one or on all of the services we offer, be assured you are choosing the right company when you choose Stage Left Redesign.
	 	</p>
	...
	<h3>Redesign</h3>
		<p>
			This service is for the home owner that doesn't quite know how to place furniture, paintings, or find the focal point of the room. We can redesign your living room, your bedroom, or your entire home by using what you already have in the home. See our before and after photos for examples of our redesigns.
		</p>
	<h3>Displays</h3>
		<p>
	...
	<h3>Accessory Rentals</h3>
		<p>
			Stage Left Redesign has a storage unit full of items to rent for all of your needs. Flowers to mirrors and paintings to vases. Let us rent you items to save you time and money. We can make every home, store or display look complete with one of the items in our rental storage. <span class="italic">(No furniture is kept in our storage unit but for a vacant home, renting furniture is highly recommended)</span> Call or email us for more information on this service now!
		</p>
